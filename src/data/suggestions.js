...
const MASTER_LIST = [
  ...
  { name: 'Work gloves', category: 'Build', condition: e => (e.buildDays || 0) > 0, singleton: true },
  { name: 'Sturdy closed-toe work shoes', category: 'Build', condition: e => (e.buildDays || 0) > 0, singleton: true },
  { name: 'Safety goggles', category: 'Build', condition: e => (e.buildDays || 0) > 0, singleton: true },
  ...
  { name: 'Tool belt / tool bag', category: 'Build', condition: e => (e.buildDays || 0) > 0, singleton: true },
  ...
  // Comfort
  { name: 'Tent', category: 'Comfort', singleton: true },
  ...
  { name: 'Shade structure / canopy', category: 'Comfort', singleton: true },
  { name: 'Rope / cordage', category: 'Comfort', singleton: true },
  { name: 'Tent stakes and mallet', category: 'Comfort', singleton: true },
  ...
  { name: 'Goggles', category: 'Clothing & Accessories', singleton: true, condition: e => e.weatherConditions?.includes('High Wind') },

  // Misc
  { name: 'Bug spray', category: 'Misc', singleton: true },
  { name: 'Lighter / matches', category: 'Misc', singleton: true },
  { name: 'Duct tape', category: 'Misc', singleton: true },
  { name: 'Zip ties', category: 'Misc', singleton: true },
  { name: 'Multi-tool', category: 'Misc', singleton: true },
